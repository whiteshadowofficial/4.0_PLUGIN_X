...
DATABASE_URL = process.env.DATABASE_URL === undefined ? './RAVANA.db' : process.env.DATABASE_URL;
...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By RAVANA' : process.env.ALL_CAPTION,
